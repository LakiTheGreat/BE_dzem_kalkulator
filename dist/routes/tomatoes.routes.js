...
import { createTomatoOrder, createTomatoTransaction, deleteTomatoOrder, deleteTomatoTransaction, getAllTomatoCups, getAllTomatoOrders, getAllTomatoTransactions, getTomatoCupTotals, getTomatoOrderById, updateTomatoOrder, updateTomatoTransaction, } from '../controllers/tomato.controller.js';
...
router.put('/transactions/:id', checkSchema(tomatoTransactionSchema), handleValidationErrors, updateTomatoTransaction);
